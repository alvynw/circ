...
arithmetic_tests = [
    [
        "Cerebro -- Add two numbers - 1",
        17,
        "./third_party/ABY/build/bin/sum_2pc_test",
        [7, 0],
        [0, 10],
    ], 
    [
        "Cerebro -- Add two numbers - 2",
        10,
        "./third_party/ABY/build/bin/sum_2pc_test",
        [0, 0],
        [0, 10],
    ...
    [
        "Cerebro -- Unroll Reveal - 1",
        47,
        "./third_party/ABY/build/bin/unroll_reveal_test",
        [1, 0],
        [0, 1],
    ], 
    [
        "Cerebro -- Unroll Reveal - 2",
        90,
        "./third_party/ABY/build/bin/unroll_reveal_test",
        [45, 0],
        [0, 0],
